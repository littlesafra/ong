...
for(i in 1:5){
    ...
    if(Renta_Mixta >= Renta_Cuadrante && porcentajePoblacion < Poblacion_Cuadrante)Cuadrante <- 1
    else if(Renta_Mixta >= Renta_Cuadrante && porcentajePoblacion >= Poblacion_Cuadrante)Cuadrante <- 2
    else if(Renta_Mixta < Renta_Cuadrante && porcentajePoblacion < Poblacion_Cuadrante)Cuadrante <- 3
    else Cuadrante <- 4
    
    if(i == 1)g1 <- data.frame(cbind(Grupo,Renta_Mixta,porcentajePoblacion,Cuadrante))
    else if(i == 2)g2 <- data.frame(cbind(Grupo,Renta_Mixta,porcentajePoblacion,Cuadrante))
    else if(i == 3)g3 <- data.frame(cbind(Grupo,Renta_Mixta,porcentajePoblacion,Cuadrante))
    else if(i == 4)g4 <- data.frame(cbind(Grupo,Renta_Mixta,porcentajePoblacion,Cuadrante))
    else g5 <- data.frame(cbind(Grupo,Renta_Mixta,porcentajePoblacion,Cuadrante))
}

...
#data.scale1kable(rescale(base$Income))
...
plot(1:k.max, wss,
     ...
     main="Número óptimo de clusters",
...
Paro <- mean(grupo1$Tasa_Paro)
Inmigracion <- sum(grupo1$Inmigracion)
grupo1.medias <- data.frame(cbind(Poblacion, Renta_Personal, Renta_Familiar, Renta_Mixta, Paro, Inmigracion))
...
Renta_Mixta <- (Renta_Personal/Renta_Familiar * 100)
Paro <- mean(grupo2$Tasa_Paro)
Inmigracion <- sum(grupo2$Inmigracion)
grupo2.medias <- data.frame(cbind(Poblacion, Renta_Personal, Renta_Familiar, Renta_Mixta, Paro, Inmigracion))
...
Renta_Mixta <- (Renta_Personal/Renta_Familiar * 100)
Paro <- mean(grupo3$Tasa_Paro)
Inmigracion <- sum(grupo3$Inmigracion)
grupo3.medias <- data.frame(cbind(Poblacion, Renta_Personal, Renta_Familiar, Renta_Mixta, Paro, Inmigracion))
...
Renta_Mixta <- (Renta_Personal/Renta_Familiar * 100)
Paro <- mean(grupo4$Tasa_Paro)
Inmigracion <- sum(grupo4$Inmigracion)
grupo4.medias <- data.frame(cbind(Poblacion, Renta_Personal, Renta_Familiar, Renta_Mixta, Paro, Inmigracion))
...
Renta_Mixta <- (Renta_Personal/Renta_Familiar * 100)
Paro <- mean(grupo5$Tasa_Paro)
Inmigracion <- sum(grupo5$Inmigracion)
grupo5.medias <- data.frame(cbind(Poblacion, Renta_Personal, Renta_Familiar, Renta_Mixta, Paro, Inmigracion))
...
Paro <- 0
Inmigracion <- 0
distancia.origen <- data.frame(cbind(Poblacion, Renta_Personal, Renta_Familiar, Renta_Mixta, Paro, Inmigracion))
